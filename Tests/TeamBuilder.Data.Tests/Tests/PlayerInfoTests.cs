...
#region Data
        ...
        /// <summary>Sample API call response for information about a player.</summary>
        private const string SAMPLE_PLAYER_DATA = "WG_PlayerInfo.json";
        ...
        private const string SAMPLE_DATA_FILE_PATH = "../../Data/" + SAMPLE_PLAYER_DATA;
